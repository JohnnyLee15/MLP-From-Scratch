...
id<MTLComputePipelineState> GpuEngine::applyWeightsGradPipeline = nil;
id<MTLComputePipelineState> GpuEngine::matMatTPipeline = nil;
id<MTLComputePipelineState> GpuEngine::mmTBiasReLUPipeline = nil;
...
id<MTLComputePipelineState> GpuEngine::col2ImSlowPipeline  = nil;
id<MTLComputePipelineState> GpuEngine::col2ImFastPipeline  = nil;
...
void GpuEngine::initAllPipes() {
    ...
    initPipe("applyWeightsGrad", applyWeightsGradPipeline);
    initPipe("mmT", matMatTPipeline);
    initPipe("mmTBiasReLU", mmTBiasReLUPipeline);
    ...
    initPipe("col2ImSlow", col2ImSlowPipeline);
    initPipe("col2ImFast", col2ImFastPipeline);
...
id<MTLComputePipelineState> GpuEngine::getApplyWeightsGradPipe() { return applyWeightsGradPipeline; }
id<MTLComputePipelineState> GpuEngine::getMatMatTPipe() { return matMatTPipeline; }
id<MTLComputePipelineState> GpuEngine::getMMTBiasReLUPipe() { return mmTBiasReLUPipeline; }
...
id<MTLComputePipelineState> GpuEngine::getCol2ImSlowPipe() { return col2ImSlowPipeline; }
id<MTLComputePipelineState> GpuEngine::getCol2ImFastPipe() { return col2ImFastPipeline; }
